            ...
            >
              ...
              <div className="relative z-10 flex flex-col items-center gap-6 md:flex-row md:items-center md:gap-8">
                ...
                <div className="text-center md:text-left flex-1">
                  ...
                  {/* Social Media Links */}
                  <div className="flex items-center gap-2 mt-4 md:mt-5 justify-center md:justify-start">
                    <a 
                      href="https://discord.gg/S7safxRM" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="p-2 rounded-full bg-[#5865F2]/10 border border-[#5865F2]/20 hover:bg-[#5865F2]/20 hover:border-[#5865F2]/40 hover:scale-110 transition-all duration-300"
                      title="Discord"
                    >
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="p-2 rounded-full bg-[#E4405F]/10 border border-[#E4405F]/20 hover:bg-[#E4405F]/20 hover:border-[#E4405F]/40 hover:scale-110 transition-all duration-300"
                      title="Instagram"
                    >
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="p-2 rounded-full bg-foreground/10 border border-foreground/20 hover:bg-foreground/20 hover:border-foreground/40 hover:scale-110 transition-all duration-300"
                      title="X (Twitter)"
                    >
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="p-2 rounded-full bg-[#0A66C2]/10 border border-[#0A66C2]/20 hover:bg-[#0A66C2]/20 hover:border-[#0A66C2]/40 hover:scale-110 transition-all duration-300"
                      title="LinkedIn"
                    >
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="p-2 rounded-full bg-[#1877F2]/10 border border-[#1877F2]/20 hover:bg-[#1877F2]/20 hover:border-[#1877F2]/40 hover:scale-110 transition-all duration-300"
                      title="Facebook"
                    >
